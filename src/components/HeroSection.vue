...
const heroContent = {
    label: "Perfekt in Esslingen",
    headline: "Snacks & Getränke.",
    headlineSub: "Frisch. 24/7.",
    description:
        "Moderne Automaten mit kalten Drinks und Lieblingssnacks – bargeldlos, zuverlässig und immer befüllt.",
};
        ...
        <div class="container hero__inner">
            ...
            <div class="hero__visual" aria-hidden="true">
                <div class="hero__card">
                    ...
                    <p class="hero__card-sub">
                        Keine Warteschlangen. Keine Kasse. Einfach holen und
                        gehen.
                    </p>
